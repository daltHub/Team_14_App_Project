...
public class CustomAdapter extends ArrayAdapter<State> {
    ...
    public CustomAdapter(Activity voting_v2, int row, ArrayList<State> states) {
...
//        this.valuelist = value;
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        State singlestate = getStatelist(position);
    ...
    CompoundButton.OnCheckedChangeListener myCheckChangList = new CompoundButton.OnCheckedChangeListener() {
        ...
        public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
            getStatelist((Integer) compoundButton.getTag()).available = isChecked;
        }
    };
